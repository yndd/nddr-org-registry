...
type Registry interface {
	...
	GetRegister(context.Context, resource.Managed) (map[string]string, error)
	GetAddressAllocationStrategy(context.Context, resource.Managed) (*nddov1.AddressAllocationStrategy, error)
